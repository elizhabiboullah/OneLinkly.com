export const FAQS_EN = [
  ...
  {
    title: "Is there a limit to how many links I can add?",
    content:
      "Yes, the Free plan offers one link per user, and the Pro plan includes unlimited links with and adding as many social media profiles, portfolio pieces, products, or other important links as you need to create a comprehensive online presence.",
  },
  {
    title: "How do I set up my custom domain?",
    content:
      "Pro users can connect their own domain in minutes through our dashboard. Simply add your domain details, update your DNS settings following our guide, and your Lin.ks page will be accessible through your custom domain, enhancing your professional presence.",
  },
  {
    title: "Can I switch between Free and Pro plans?",
    content:
      "Yes, you can upgrade to Pro or downgrade to Free at any time. When upgrading, you'll immediately gain access to all Pro features. If you downgrade, you'll retain access to Pro features until the end of your current billing period.",
  },
  {
    title: "What support do you offer?",
    content:
      "Free users have access to our help center and community support. Pro users receive priority support with faster response times and dedicated assistance for technical issues or customization needs.",
  },
  {
    title: "Is Lin.ks mobile-friendly?",
    content:
      "Yes, Lin.ks pages are fully responsive and optimized for all devices. Your page will look perfect whether visitors are viewing it on desktop, tablet, or mobile devices.",
  },
  {
    title: "How secure is Lin.ks?",
    content:
      "We prioritize security with features like SSL encryption, regular security updates, and robust data protection measures. Your data and your visitors' information are always protected with industry-standard security protocols.",
  },
];
