...
import { BsGithub, BsFillPaletteFill, BsFillStarFill, BsFileEarmarkBarGraphFill, BsFillRocketTakeoffFill   } from "react-icons/bs";
...
export const FEATURES_EN = [
  {
    title: "Beautiful Fully Customizable Links",
    content: "Everything you need to build your online presence in one place. in minutes.",
    icon: BsFillPaletteFill,
  },
  {
    title: "Beautiful Themes",
    content: "Choose from a variety of professional, responsive themes, or create your own unique design.",
    icon: BsFillStarFill,
  },
  {
  ...
  },
  {
    ...
    content: "Gain insights into your link performance with detailed analytics and visitor behavior tracking.",
    icon: BsFileEarmarkBarGraphFill,
  },
  {
    title: "Quick Setup",
    content: "Get started in minutes with our easy-to-use interface and intuitive page creation tools.",
    icon: BsFillRocketTakeoffFill,
  },
  {
    title: "Custom Domain Support",
    content: "Easily connect your own domain or use a lin.ks subdomain for a fully branded experience",
    icon: FaEarthAsia,
  },
];
